...
## Version Management
- **Current Version**: 3.5.1 (Last Updated: 2025-08-18)
...
- **Title Updates**: When updating versions, remember to update:
  - `<title>Query Analyzer v3.5.1</title>` in index.html header
  - `<meta name="version" content="3.5.1" />` in index.html meta tags
  - `APP_VERSION = '3.5.1';` in JavaScript constants
