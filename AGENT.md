...
## Version Management
- **Current Version**: 3.7.1 (Last Updated: 2025-01-26)
...
- **Title Updates**: When updating versions, remember to update:
  - `<title>Query Analyzer v3.7.1</title>` in index.html header
  - `<meta name="version" content="3.7.1" />` in index.html meta tags
  - `APP_VERSION = '3.7.1';` in JavaScript constants
